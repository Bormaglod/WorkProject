//-----------------------------------------------------------------------
// <copyright file=ImageMap.cs company="Sergey Teplyashin">
...
// <time>18:02</time>
// <summary>Defines the ImageMap.</summary>
//-----------------------------------------------------------------------
...
namespace WorkProject.Data.Mappings
{
    ...
    public class ImageMap : IAutoMappingOverride<Image>
    {
        ...
        {
            mapping.IgnoreProperty(x => x.Dest);
            mapping.IgnoreProperty(x => x.Alias);
        }
    }
}
